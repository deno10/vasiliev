...
<!DOCTYPE html>
	...
	<head>
		<meta charset="utf-8">
		<title>Закрепы для историй</title>
...
?>
		<?php
		$result = mysqli_query($link, "SELECT * FROM `pins`;") or die (mysqli_error($link));
		?>
